...
<div id="page">
    ...
    <div  style="background-color: whitesmoke"><br>
        <div  class="container" style="background-color: whitesmoke">
            <div style="float: left"><h1 style="color: black; ">【双人间-屋内实景】</h1></div>
            <div style="float: right"><button type="button" class="btn btn-dark" onclick="window.history.back();">返回</button></div>
        </div><br>
    </div>

    <!--singleroom-->
    <div class="image-head-wrapper" style="background-image: url('/familyhotel/resources/imgs/roompic/double.jpg');background-size: 75% 100%;background-color: whitesmoke">
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="gallery-image">
                        <img class="img-responsive" src="<spring:url value='/resources/imgs/roompic/d1.jpg'/>">
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="gallery-image">
                        <img class="img-responsive" src="<spring:url value='/resources/imgs/roompic/d2.jpg'/>">
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="gallery-image">
                        <img class="img-responsive" src="<spring:url value='/resources/imgs/roompic/d3.jpg'/>">
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="gallery-image">
                        <img class="img-responsive" src="<spring:url value='/resources/imgs/roompic/d4.jpg'/>">
                    </div>
                </div>
            </div>
        </div>
