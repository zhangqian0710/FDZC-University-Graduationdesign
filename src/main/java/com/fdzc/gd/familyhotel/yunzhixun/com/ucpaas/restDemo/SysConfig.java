package com.fdzc.gd.familyhotel.yunzhixun.com.ucpaas.restDemo;
	...
	public void loadConfigProps() {
		...
		try {
			is = getClass().getResourceAsStream(
					"classpath:yunzhixun/config.properties");
			if (is == null) {
				is = getClass().getResourceAsStream("/yunzhixun/config.properties");
			}
