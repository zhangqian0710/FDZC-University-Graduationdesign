                ...
                <div class=" col-md-12">
                    <div class="card card-shadow mb-4">
                        ...
                        <div class="card-body" style="height: 577px;">
                            <form action="create"   Class="right-text-label-form"  id="roomForm" method="post" enctype="multipart/form-data" modelAttribute="room"  >
                            <div style="margin-left: 200px;">

                                <div style="float: left">
                                    <div class="form-group row" style="width: 450px;height: 140px;">
                                        <h6 class="mt-3">房间图片：</h6>
                                        <img id="picImg" src="<c:url value="/resources/imgs/no-pic.png"/>" width="200" height="130" class="py-1"><br>
                                ...
                                <div style="float: left;margin-left: 50px;">
                                    <div class="form-group row" style="width: 450px;height: 65px;">
                                        <h6 class="mt-3">房间编号：</h6>
                                        <input type="text" Class="form-control" name="roomNo" id="roomNo" maxlength="20" style="width: 400px" placeholder="请输入房间编号"/>
                                    </div>
                                    <br>
                                    <div class="form-group row" style="width: 450px;height: 65px;">
                                        <h6 class="mt-3">房间价格：(1晚)</h6>
                                        <input type="text" Class="form-control" name="roomPrice" id="roomPrice" maxlength="10" style="width: 400px" placeholder="请输入房间价格"/>
                                    </div>
                                </div>
                                ...
                                <div style="float: left; margin-top: 10px; height: 150px;" >
                                    <div class="form-group row" style="width: 450px;height: 40px;">
                                        ...
                                        <label class="control control-solid control-solid-info control--radio">单人间：<i class="fa fa-male fa-lg"></i>
                                            <input type="radio" name="roomType" value="a" name="radio" checked />
                                        ...
                                        <label class="control control-solid control-solid-info control--radio">双人间：<i class="fa fa-male fa-lg"></i><i class="fa fa-female fa-lg"></i>
                                            <input type="radio" name="roomType" value="b" name="radio"  />
                                            <div class="control__indicator"></div> </label>
                                        </div>&nbsp;&nbsp;
                                        <div style="margin-top: 13px;">
                                        <label class="control control-solid control-solid-info control--radio">家庭套房：<i class="fa fa-male fa-lg"></i><i class="fa fa-child fa-lg"></i><i class="fa fa-female fa-lg"></i>
                                            <input type="radio" name="roomType" value="c" name="radio"  />
                                            <div class="control__indicator"></div> </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="width: 450px;height: 40px;">
                                        ...
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input"  name="roomEquip" value="a" checked>
                                    ...
                                    <div class="form-group row" style="width: 450px;height: 40px;">
                                        ...
                                        <div style="margin-top: 13px;">
                                            <label class="control control-solid control-solid-info control--radio">未预定
                                                <input type="radio" name="roomStatus" value="a" name="radio" checked />
                                                <div class="control__indicator"></div> </label>
                                        </div>&nbsp;&nbsp;
                                        <div style="margin-top: 13px;">
                                            <label class="control control-solid control-solid-danger control--radio">已预定
                                                <input type="radio" name="roomStatus" value="b" name="radio"  />
                                                <div class="control__indicator"></div> </label>
                                        </div>&nbsp;&nbsp;
                                        <div style="margin-top: 13px;">
                                            <label class="control control-solid control-solid-success control--radio">已入住
                                                <input type="radio" name="roomStatus" value="c" name="radio"  />
                                                <div class="control__indicator"></div> </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="float: left;margin-left: 50px; margin-top: 10px;">
                                    <div class="form-group row" style="width: 400px;height: 140px;">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" maxlength="200" name="roomMemo" rows="3"></textarea>
                                    </div>
